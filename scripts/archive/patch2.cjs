...
const regex = /function getCurrentFormCode\(\) \{[\s\S]*?return FORM_CODE_MAP\[lookupKey\] \|\| 9999;\s*\}/;
...
if (regex.test(code)) {
  fs.writeFileSync('src/components/DynamicForms/LegacyFormWrapper.jsx', code.replace(regex, newFunc));
