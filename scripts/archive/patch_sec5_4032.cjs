...
if (!content.includes('formCode === 4032')) {
  if (content.includes(targetStr)) {
    ...
    console.log('Patched case 4032 in Section5Renderer.js');
  } else {
    console.log('Target string not found in Section5Renderer.js');
  }
} else {
  console.log('case 4032 already exists in Section5Renderer.js');
}
