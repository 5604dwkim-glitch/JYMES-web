...
const MOLD_TYPE_MAP = {
  ...
  1022: ["공통", "LH", "RH"],
  1042: ["공통", "LH", "RH"],
  2003: ["LH", "RH", "R[직각]", "S[둔각]", "T[직선]", "LH R[직각]", "LH S[둔각]", "LH T[직선]", "RH R[직각]", "RH S[둔각]", "RH T[직선]", "1", "2", "3", "4"],
  2013: ["LH", "RH", "R[직각]", "S[둔각]", "T[직선]", "LH R[직각]", "LH S[둔각]", "LH T[직선]", "RH R[직각]", "RH S[둔각]", "RH T[직선]", "1", "2", "3", "4"],
  2024: ["LH", "RH", "R[직각]", "S[둔각]", "T[직선]", "LH R[직각]", "LH S[둔각]", "LH T[직선]", "RH R[직각]", "RH S[둔각]", "RH T[직선]", "1", "2", "3", "4"],
  2025: ["LH", "RH", "D", "R[직각]", "S[둔각]", "T[직선]", "LH R[직각]", "LH S[둔각]", "LH T[직선]", "RH R[직각]", "RH S[둔각]", "RH T[직선]", "1", "2", "3", "4"],
  2033: ["LH", "RH", "R[직각]", "S[둔각]", "T[직선]", "LH R[직각]", "LH S[둔각]", "LH T[직선]", "RH R[직각]", "RH S[둔각]", "RH T[직선]", "1", "2", "3", "4"],
  2042: ["LH", "RH"],
