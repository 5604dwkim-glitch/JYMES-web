...
export function renderSection4LotTable(materialLots = {}, ctx) {
  const { container, processValue, carModelValue, currentCarCode, partValueInput, existingData, getCurrentFormCode, bindLotDateWheelPicker } = ctx;
    ...
    if (!curProc || noLotFormCodes.includes(formCode) || (curProc.includes('검사') && !isStellantisInsp && formCode !== 3004 && formCode !== 4014 && formCode !== 4004 && formCode !== 1004 && formCode !== 1034 && formCode !== 1024 && formCode !== 1044)) {
    ...
    switch (formCode) {
      ...
      case 4004: {
        ...
        break;
            ...
            // ────────────────────────────────────────────────────────
      // ────────────────────────────────────────────────────────
      // #3001, #3002 : NE1a D/SIDE 소재준비/조인트 전용 양식 (LH / RH 2개 표, FRT A / RR A / RR C / RR D)
      // ────────────────────────────────────────────────────────
      case 3001:
      case 3002:
      case 3003:
      case 3004: {
        const rows = formCode === 3002 ? [
