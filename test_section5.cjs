...
const ctx = { container: { querySelector: () => ({ innerHTML: '', addEventListener: () => {} }), querySelectorAll: () => [] }, processValue: { value: '조인트' }, carModelValue: { value: 'JG1' }, currentCarCode: 'JG1', partValueInput: { value: 'G/RUN \'E\'' }, existingData: null, getCurrentFormCode: () => 1022, bindNumberWheelPicker: () => {} };
 try { renderSection5(ctx); console.log('NO ERROR'); } catch(e) { console.log('ERROR:', e.stack); }