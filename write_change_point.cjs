...
export default function ChangePointManagement() {
  ...
  return (
    <div style={{ padding: '20px', height: '100vh', display: 'flex', flexDirection: 'column', overflow: 'hidden', background: '#f8fafc' }}>
...
fs.writeFileSync('src/components/ChangePointManagement.jsx', code);
console.log('ChangePointManagement.jsx created successfully.');
